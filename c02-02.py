...
for _ in range(20000):
    ...
    train_acc_val = sess.run(accuracy, feed_dict={x: train_x, t: train_t})
    train_accuracy.append(train_acc_val)
    test_acc_val = sess.run(accuracy, feed_dict={x: test_x, t: test_t})
    test_accuracy.append(test_acc_val)
    print train_acc_val, test_acc_val
